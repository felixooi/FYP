...
# Feature Engineering
# ----------------------------------------------------------------
def create_workload_features(df):
    ...
    df_eng["Workload_Intensity"] = (
        ...
        + (df_eng["Overtime_Hours"] / df_eng["Overtime_Hours"].max()) * 0.3
        + (df_eng["Projects_Handled"] / df_eng["Projects_Handled"].max()) * 0.3
    )
    ...
    df_eng["Burnout_Risk"] = (
        ...
        + (df_eng["Overtime_Hours"] > df_eng["Overtime_Hours"].quantile(0.75)).astype(int)
        * 0.3
        + (df_eng["Sick_Days"] > df_eng["Sick_Days"].quantile(0.75)).astype(int) * 0.2
    ...
    df_eng["Salary_Performance_Gap"] = (
        (df_eng["Monthly_Salary"] - df_eng["Monthly_Salary"].mean())
        / df_eng["Monthly_Salary"].std()
        - (df_eng["Performance_Score"] - df_eng["Performance_Score"].mean())
        / df_eng["Performance_Score"].std()
    )
